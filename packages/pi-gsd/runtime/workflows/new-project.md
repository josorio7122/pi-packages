...
```bash
INIT=$(Use the gsd_init tool with action: "new-project")
```
...
```bash
mkdir -p .planning
Use the gsd_util tool with action: ""chore:", args: add project config" --files .planning/config.json
```

**Persist auto-advance to config (survives context compaction):**

```bash
Use the gsd_config tool with action: "set", args: workflow.auto_advance true
```
...
```bash
mkdir -p .planning
Use the gsd_util tool with action: ""docs:", args: initialize project" --files .planning/PROJECT.md
```
...
Use template: $GSD_RUNTIME_PATH/templates/research-project/STACK.md
</output>
  """
)
...
Use template: $GSD_RUNTIME_PATH/templates/research-project/FEATURES.md
</output>
  """
)
...
Use template: $GSD_RUNTIME_PATH/templates/research-project/ARCHITECTURE.md
</output>
  """
)
...
Use template: $GSD_RUNTIME_PATH/templates/research-project/PITFALLS.md
</output>
  """
)
```
...
Use template: $GSD_RUNTIME_PATH/templates/research-project/SUMMARY.md
...
```bash
Use the gsd_util tool with action: ""docs:", args: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
Use the gsd_util tool with action: ""docs:", args: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
