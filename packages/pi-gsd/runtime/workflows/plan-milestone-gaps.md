...
PHASES=$(Use the gsd_phase tool with action: "list")
...
```bash
Use the gsd_util tool with action: ""docs(roadmap"): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
