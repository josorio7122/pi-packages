...
```bash
INIT=$(Use the gsd_init tool with action: "progress")
```
...
- `STATE=$(Use the gsd_state tool with action: "snapshot")`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  Use the gsd_util tool with action: "summary-extract", args: <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(Use the gsd_util tool with action: "bar", args: --raw)
```
