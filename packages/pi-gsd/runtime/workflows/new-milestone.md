...
```bash
Use the gsd_util tool with action: ""docs:", args: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(Use the gsd_init tool with action: "new-milestone")
```
...
Use the gsd_config tool with action: "set", args: workflow.research true

# If "Skip research": persist false
Use the gsd_config tool with action: "set", args: workflow.research false
```
...
Use template: $GSD_RUNTIME_PATH/templates/research-project/{FILE}
</output>
  """
)
```
...
**Commit requirements:**
```bash
Use the gsd_util tool with action: ""docs:", args: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
Use the gsd_util tool with action: ""docs:", args: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
