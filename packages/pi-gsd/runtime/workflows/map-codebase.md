...
```bash
INIT=$(Use the gsd_init tool with action: "map-codebase")
```
...
3. Consider adding sensitive files to your pi project ignore list
...
```bash
Use the gsd_util tool with action: ""docs:", args: map existing codebase" --files .planning/codebase/*.md
```
