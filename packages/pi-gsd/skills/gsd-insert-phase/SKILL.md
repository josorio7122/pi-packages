...
description: Insert a phase between existing phases using decimal numbering.
---
...
- At least two phases must exist in the roadmap
...
Read and follow: `$GSD_RUNTIME_PATH/workflows/insert-phase.md`
