...
description: Comprehensive audit of a milestone — coverage, quality, and completeness.
---
...
- A milestone must be identified (by name or number within the current phase)
...
Read and follow: `$GSD_RUNTIME_PATH/workflows/audit-milestone.md`
