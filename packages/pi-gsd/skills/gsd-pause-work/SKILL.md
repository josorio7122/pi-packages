---
name: gsd-pause-work
description: Save current session state for resumption later. Captures progress, context, and continuation notes.
---
...
- An active GSD session in progress
...
Read and follow: `$GSD_RUNTIME_PATH/workflows/pause-work.md`
