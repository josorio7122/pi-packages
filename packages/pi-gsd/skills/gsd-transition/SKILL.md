---
name: gsd-transition
description: Transition between phases — complete current phase and prepare next.
---
...
- An active phase in progress
- Current phase must be ready for completion
...
Read and follow: `$GSD_RUNTIME_PATH/workflows/transition.md`
