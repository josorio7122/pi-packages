---
name: gsd-progress
description: Show current project progress — phase status, plan completion, blockers, and next steps.
---
...
- `gsd-start` must have been run at least once
...
Read and follow: `$GSD_RUNTIME_PATH/workflows/progress.md`
