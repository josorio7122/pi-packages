...
description: Set the model quality profile (quality, balanced, budget) for agent dispatch.
---
...
- Profile must be one of: `quality`, `balanced`, `budget`
...
Read and follow: `$GSD_RUNTIME_PATH/workflows/set-profile.md`
