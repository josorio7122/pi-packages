...
description: Start a new milestone after completing the previous one. Sets up fresh phases and requirements.
---
...
- Previous milestone must have been archived (run `gsd-complete-milestone` first if not done)
...
`$GSD_RUNTIME_PATH/workflows/new-milestone.md`
