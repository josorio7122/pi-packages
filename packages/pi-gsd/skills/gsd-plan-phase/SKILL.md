---
name: gsd-plan-phase
description: Create detailed execution plans for a phase. Spawns planner agents to break requirements into actionable plans with dependencies.
---
...
- Phase requirements should have been discussed (via `gsd-discuss-phase`) before planning
...
- **planner** — breaks phase requirements into actionable execution plans
- **plan-checker** — reviews plans for completeness, dependencies, and correctness

## Workflow

Read and follow the workflow instructions at:
`$GSD_RUNTIME_PATH/workflows/plan-phase.md`
