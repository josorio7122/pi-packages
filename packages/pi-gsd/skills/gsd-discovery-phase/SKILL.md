...
description: Run discovery for a phase — research technologies, APIs, and patterns before planning.
---
...
- A phase must be identified (by number or name)
...
Key agents used: `project-researcher`, `phase-researcher`, `research-synthesizer`

## Workflow

Read and follow: `$GSD_RUNTIME_PATH/workflows/discovery-phase.md`
